            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php
                            $cek = $this->Muser->get_user_by_id_unit(1000);
                            ?>
                            <form method="POST" action="<?=base_url('admin/pass_exchange')?>">
                                ...
                                <br>
                                <button type="submit" class="btn btn-primary m-t-15 waves-effect" onclick="return confirm('Anda yakin?')">SIMPAN</button>
                            </form>
                        </div>
                    </div>
                </div>
