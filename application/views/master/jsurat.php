                                        ...
                                        <th  style="background-color: gainsboro;"><font><?=$judul?></font></th>
                                          ...
                                          <?php 
                                            foreach ($sql->result_array() as $tampil){
                                             ?> 
                                                <tr>
                                                  <td><font size=""><?php echo $tampil['kd_jenis']?></font></td>
                                                  <td><font size=""><?php echo $tampil['nm_jenis']?></font></td>
                                                  <td>
                                                    <a href="#" class='open_modal' id='<?php echo  $tampil['id']; ?>'><i class="fas fa-edit"> Edit</i></a>            
                                                    <a href="#" 
                                                    onclick="confirm_modal('<?=base_url()?>C_master/jsuratDel?&modal_id=<?=$tampil['id']?>');"><i class="far fa-times-circle"> Hapus</i></a>
                                                  </td>
                                                </tr>
                                             <?php
                                            }
