                                        ...
                                        <th  style="background-color: gainsboro;"><font><?=$judul?></font></th>
                                          ...
                                          <?php 
                                            foreach ($sql->result_array() as $tampil){
                                             ?> 
                                                <tr>
                                                  <td><font size=""><?php echo $tampil['kd_kegiatan']?></font></td>
                                                  <td><font size=""><?php echo $tampil['nm_kegiatan']?></font></td>
                                                  <td>
                                                    <a href="#" class='open_modal' id='<?php echo  $tampil['id']; ?>'><i class="fas fa-edit"> Edit</i></a>            
                                                    <a href="#" 
                                                    onclick="confirm_modal('<?=base_url()?>C_master/kegiatanDel?&modal_id=<?=$tampil['id']?>');"><i class="far fa-times-circle"> Hapus</i></a>
                                                  </td>
                                                </tr>
                                             <?php
                                            }
