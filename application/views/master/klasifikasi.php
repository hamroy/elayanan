                              ...
                              ?>
                                <table class="table table-striped table-bordered">
                                    <tr>    
                                        ...
                                        <th  style="background-color: gainsboro;"><font>Nama Klasifikasi</font></th>
                                        <th  style="background-color: gainsboro;"><font>Keterangan</font>
                                          ...
                                          <?php 
                                            foreach ($sql->result_array() as $tampil){
                                             ?> 
                                                <tr>
                                                  <td><font size=""><?php echo $tampil['kd_klasifikasi']?></font></td>
