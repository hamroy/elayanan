...
<tr>
    ...
    <td><input name="kompetensi1" type="radio" id="radio_kompetensi1a" class="with-gap radio-col-green" value=".1" <?php if($ceknilai == TRUE)
        ...
        <td>
            <a href="<?=base_url('Kompetensi1/tambah/'.$pegawai->row()->id_pegawai)?>" class="btn btn-warning btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Unggah Dokumen">
            <i class="material-icons">file_upload</i>
            </a>
            
            <a href="<?=base_url('Kompetensi1/index/'.$pegawai->row()->id_pegawai)?>" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Lihat Dokumen" >
...
<tr>
    ...
    <td><input name="kompetensi2" type="radio" id="radio_kompetensi2a" class="with-gap radio-col-green" value=".1" <?php if($ceknilai == TRUE)
        ...
        <td>
            <a href="<?=base_url('Kompetensi2/tambah/'.$pegawai->row()->id_pegawai)?>" class="btn btn-warning btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Unggah Dokumen">
            <i class="material-icons">file_upload</i>
            </a>
            
            <a href="<?=base_url('Kompetensi2/index/'.$pegawai->row()->id_pegawai)?>" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Lihat Dokumen" >
            <i class="material-icons">pageview</i>
            </a>
...
<tr>
    ...
    <td><input name="kompetensi3" type="radio" id="radio_kompetensi3a" class="with-gap radio-col-green" value=".1" <?php if($ceknilai == TRUE)
        ...
        <td>
            <a href="<?=base_url('Kompetensi3/tambah/'.$pegawai->row()->id_pegawai)?>" class="btn btn-warning btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Unggah Dokumen">
            <i class="material-icons">file_upload</i>
            </a>
            
            <a href="<?=base_url('Kompetensi3/index/'.$pegawai->row()->id_pegawai)?>" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Lihat Dokumen" >
            <i class="material-icons">pageview</i>
            </a>
...
<tr>
    ...
    <td><input name="kompetensi4" type="radio" id="radio_kompetensi4a" class="with-gap radio-col-green" value=".1" <?php if($ceknilai == TRUE)
        ...
        <td>
            <a href="<?=base_url('Kompetensi4/tambah/'.$pegawai->row()->id_pegawai)?>" class="btn btn-warning btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Unggah Dokumen">
            <i class="material-icons">file_upload</i>
            </a>
            
            <a href="<?=base_url('Kompetensi4/index/'.$pegawai->row()->id_pegawai)?>" class="btn btn-primary btn-xs waves-effect" data-toggle="tooltip" data-placement="left" title="Lihat Dokumen" >
            <i class="material-icons">pageview</i>
            </a>
